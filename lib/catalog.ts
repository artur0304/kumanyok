...
export const initialResources:Resource[] = [[1600,1800],[1600,1800],[1500,1700],[1600,1800],[2900,3400],[2000,2300],[2400,2700],[2400,2600],[1600,1600],[2400,2900]].map((p,i)=>({id:`gazebo-${i+1}`,name:`Альтанка №${i+1}`,weekday:p[0],weekend:p[1],weekendStart:i===9?5:6,kind:'gazebo',photo:gazeboPhotos[i],description:gazeboDescriptions[i]}));
